...
df_compras = pd.read_csv(caminho_arquivo , sep=';' , index_col=0)

colunas = list(df_compras.columns)
colunas_selecionadas = st.sidebar.multiselect('Selecionando colunas:' , colunas , colunas)
...
st_limpar = col2.button("Limpar Filtros")
