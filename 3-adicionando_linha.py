...
df_compras = pd.read_csv(f'{caminho_datasets}/compras.csv' , sep=';' , decimal=',')
...
if st.sidebar.button("Adicionar nova Compra"): 
    ...
    df_compras.to_csv(f'{caminho_datasets}/compras.csv',sep=';' , index=False,decimal =',')
    
    st.success("Compras adicionadas") 
